## Запускать тесты надо без запуска докер контейнеров
...
6. ВСЕ ТЕСТЫ Е2Е, ТО ЕСТЬ ПРОВЕРЯЮТ ВСЕ ВЗАИМОДЕЙСТВИЕ front-back-db, ДЛЯ РАБОТЫ ТЕСТОВ НУЖНЫ ЭТИ РАБОТАЮЩИЕ СЕРВИСЫ
